/*
  # Fix feedback submission constraints

  1. Changes
    - Modify the interactions table to make related_to column nullable
    - Update submit_feedback function to handle local IDs better
    - Fix session history display issues
*/
